  ...
  <div class="wrapper_chitiet">
    ...
    <form method="POST" action="pages/main/themgiohang.php?idsanpham=<?php echo $row_chitiet['id_sanpham'] ?> ">
      <div class="chitiet_sanpham">
        <h3 style="margin: 4px; font-style:italic">SẢN PHẨM: <?php echo $row_chitiet['tensanpham'] ?></h3>
        ...
        <p> <input class="themgiohang" name="themgiohang" type="submit" value="Thêm giỏ hàng">
        </p>
      </div>
    </form>
  </div>
  <div class="clear"></div>
  <div class="tabs" style="padding-top:2px ;">
    <ul id="tabs-nav">
